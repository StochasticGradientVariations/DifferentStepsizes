...
με εκτυπώσεις προόδου και μέτρηση χρόνου.
"""
...
def main():
    ...
    # Αριθμός επαναλήψεων
    N  = 30000    # για γρήγορο τρέξιμο δοκιμάζεις μικρότερο N
    ...
    # Τρέξιμο & συλλογή losses με πρόοδο
    for name, opt in zip(labels, opts):
        t0 = time.time()
