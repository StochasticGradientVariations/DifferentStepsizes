...
from optimizer_adaptive_npgm_to_sgd import AdaptiveSGD
...
def run_adsgd_debug(
    ...
    initial_lr = 1.0  # λ₀ for Adaptive SGD debugging
...
if __name__ == "__main__":
    ...
    seeds = [int(s) for s in rng.choice(max_seed, size=args.n_seeds, replace=False)]
    ...
    for seed in seeds:
        ...
        save_results(
            ...
            method="adsgd_debug", experiment="cifar10_resnet18",
